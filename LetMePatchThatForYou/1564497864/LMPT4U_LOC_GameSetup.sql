...
( 'LOC_LMPT4U_HERDSMANINLATINAMERICA_CONFIG_NAME',
  ...
  'de_DE' ),
( 'LOC_LMPT4U_HERDSMANINLATINAMERICA_CONFIG_DESC',
  '[COLOR:SuzerainDark]Mod: Herdsman[ENDCOLOR] (by AOM)[NEWLINE][ICON_ProductionQueue] Kompatibilitäts-Patch von H.Humpel.[NEWLINE][NEWLINE]Dieser Patch läßt den Hirten die Ressourcen aus dem "Latin American Resources" Mod nutzen.',
  'de_DE' );
