...
( 'LMPT4U_REINDEER_CONFIG',           -- ParameterId
  'LOC_LMPT4U_REINDEER_CONFIG_NAME',  -- Name
  'LOC_LMPT4U_REINDEER_CONFIG_DESC',  -- Description
  'bool',                             -- Domain
  1,                                  -- DefaultValue
  'Game',                             -- ConfigurationGroup
  'LMPT4U_REINDEER_CONFIG',           -- ConfigurationId
