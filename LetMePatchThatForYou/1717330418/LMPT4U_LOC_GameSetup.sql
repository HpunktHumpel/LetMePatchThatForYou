...
( 'LOC_LMPT4U_VERYNICEMAGAZINE_CONFIG_NAME',
  ...
  'de_DE' ),
( 'LOC_LMPT4U_VERYNICEMAGAZINE_CONFIG_DESC',
  '[COLOR:SuzerainDark]Mod: Very Nice Magazin[ENDCOLOR] (by Mgwska)[NEWLINE][ICON_GreatArtist] Kosmetischer Patch von H.Humpel.[NEWLINE][NEWLINE]Ein kleiner Patch, durch den der Name und die Beschreibung des Lagerhauses berichtigt bzw. eingefügt werden.',
  'de_DE' );
