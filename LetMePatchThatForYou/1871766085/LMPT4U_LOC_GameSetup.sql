...
( 'LOC_LMPT4U_LYCEUM_CONFIG_NAME',
  ...
  'de_DE' ),
( 'LOC_LMPT4U_LYCEUM_CONFIG_DESC',
  '[COLOR:SuzerainDark]Mod: Lyceum[ENDCOLOR] (by Linguaphile)[NEWLINE][ICON_GreatArtist] Kosmetischer Patch von H.Humpel.[NEWLINE][NEWLINE]Ein kleiner Patch, durch den der Name und die Beschreibung des Lyzeums berichtigt bzw. eingefügt werden.',
  'de_DE' );
